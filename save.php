...
require 'pdf/vendor/autoload.php';
 ...
 if($conn === false){echo "Failed";die;
        ...
        $sql = "INSERT INTO oncology (patient,total1,total2,total3,total4,total5) VALUES ('patient','$total1','$total2','$total3','$total4','$total5')";
    ...
    // Fetch the PDF data as an associative array
        ...
        $html.='<h1 style="text-align:center;">ONCOLOGY</h1>';
       $html.='<table style="border:1px solid black;border-collapse: collapse;">';
       $html.='<tr><td style="border:1px solid black;border-collapse: collapse;">Patient</td>
       <td style="border:1px solid black;border-collapse: collapse;">Health Score</td></tr>';
